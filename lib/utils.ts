...
export function mapRequestType(type: RequestType, lang: string) {
  ...
  switch (type) {
    case RequestType.TECHNICIAN:
      return {
        key: RequestType.TECHNICIAN,
        value: isAr ? "التعاقد مع فني" : "Hire a technician",
      };
    case RequestType.CONTRACTOR:
      return {
        key: RequestType.CONTRACTOR,
        value: isAr ? "التعاقد مع مقاول عام" : "Hiring a general contractor",
      };
    case RequestType.DESIGNER:
      return {
        key: RequestType.DESIGNER,
        value: isAr ? "التعاقد مع مصمم داخلي" : "Hiring an interior designer",
      };
    case RequestType.ENGINEERING:
      return {
        key: RequestType.ENGINEERING,
        value: isAr
          ? "التعاقد مع مكتب هندسي"
    ...
    case RequestType.QUANTITY:
      return {
        ...
        value: isAr
          ? "حساب الكميات وخطط الإنقاذ"
          : "Quantity surveying and rescue plans",
      };
    default:
      return {
        key: RequestType.TECHNICIAN,
